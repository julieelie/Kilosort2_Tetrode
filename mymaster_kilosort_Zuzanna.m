function mymaster_kilosort_Zuzanna(rootZ,SaveMat)
...
run(fullfile(pathToYourConfigFile, 'config32ch.m'))
...
elseif ops.NchanTOT==32
    chanMapFile ='Linear32x1_kilosortChanMap.mat';
else
