...
rootH = 'C:\Users\Dell Workstation\Documents\DataKilosort2\Temp'; % path to temporary binary file (same size as data, should be on fast SSD)
...
ops.fbinary = fullfile(rootZ, fs(7).name);
